  ...
  return (
    <section id="contact" className="section-padding bg-bg relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        <div className="mb-24">
          <h2 className="text-[40px] sm:text-[60px] md:text-[120px] font-display font-bold leading-none mb-4 md:mb-8 uppercase">Let's build</h2>
          <h2 className="text-[40px] sm:text-[60px] md:text-[120px] font-display font-bold leading-none mb-8 md:mb-12 uppercase gradient-text">Together.</h2>
